...
#5. make a fuction to take a paramether difficulty for 'easy' (10 attemps) and 'hard' level, (5 attemps)
...
#6. Ask if the customer wish to play again and save answer in the variable to_play. if the customer write 'yes' re-start the program to the step 3. so encapsule the program in While loop to_play. if the customer choose 'no' end and exit program.
